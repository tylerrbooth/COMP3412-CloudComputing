...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_assignment2_0880562
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_assignment2_0880562', type=str)
        file_names = []
        #####################
        # Your code is here #
        ####################
